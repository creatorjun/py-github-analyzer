...
class Config:
    ...
    BINARY_EXTENSIONS = {
        ...
        '.com', '.bat', '.cmd', '.msi', '.dmg', '.pkg', '.deb', '.rpm',
        
        # Archives
        '.zip', '.tar', '.gz', '.bz2', '.xz', '.7z', '.rar', '.ace', '.arj',
        '.cab', '.lzh', '.lha', '.sit', '.sea', '.bin', '.hqx', '.uu',
        ...
        '.m4v', '.3gp', '.ogv', '.wav', '.flac', '.aac', '.ogg', '.wma',
        ...
        # Fonts
        '.woff', '.woff2', '.ttf', '.eot', '.otf', '.pfb', '.pfm',
    ...
    SKIP_DIRECTORIES = {
        ...
        '.idea', '.vscode', '.vs', '.eclipse', '.netbeans',
    ...
    LANGUAGE_PATTERNS = {
        'python': {'extensions': ['.py'], 'files': ['setup.py', 'requirements.txt', 'pyproject.toml']},
        'javascript': {'extensions': ['.js', '.jsx'], 'files': ['package.json', 'yarn.lock']},
        'typescript': {'extensions': ['.ts', '.tsx'], 'files': ['tsconfig.json', 'tslint.json']},
